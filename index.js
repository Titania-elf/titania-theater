...
const DEFAULT_PRESETS = [
    ...
    { id: "p_xianxia", mode: "parallel", name: "🏔️ 仙侠修真", desc: "【平行】师尊与徒弟，或者正邪不两立的修仙界。", prompt: "【平行世界：古风修仙】忽略历史背景。{{char}} 是高冷的师尊或魔教教主，{{user}} 是弟子或正道少侠。描写一段在洞府修炼、传功或对峙的场景。CSS样式参考：水墨山水画背景，典雅古风边框。" },
    ...
    { id: "p_detective", mode: "parallel", name: "🕵️ 黑色侦探", desc: "【平行】上世纪40年代，爵士乐、雨夜与私家侦探。", prompt: "【平行世界：黑色电影Noir】忽略历史背景。{{char}} 是落魄侦探或致命伴侣。场景是烟雾缭绕的事务所，窗外下着大雨。用第一人称独白风格描写。CSS样式参考：黑白电影滤镜，打字机字体，老照片质感。" },
